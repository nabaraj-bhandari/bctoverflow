...
export function SubjectResourcesSection({ subject }: Props) {
  ...
  return (
    <section className="backdrop-blur-md bg-white/5 border border-white/10 rounded-sm overflow-hidden transition-all duration-300 hover:bg-white/8 hover:border-white/15">
      <div
        className="flex items-center justify-between px-4 py-3 md:cursor-default cursor-pointer select-none"
      ...
      >
        ...
        <button className="md:hidden text-primary p-1 rounded-sm hover:bg-white/5 transition-colors">
          <ChevronDown
      ...
      <div
        className={`border-t border-white/10 bg-white/3 md:block ${
